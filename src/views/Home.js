    ...
    return (
        ...
        >
            ...
            <div className="md:relative md:w-80 md:h-3/4">
                ...
                <p className="text-center md:text-left">Bienvenidos, mi nombre es <Highlight>Jorge Soria</Highlight> y tengo <Highlight>21 años</Highlight></p>
                ...
                <div className="bg-white/60 dark:bg-slate-800/80 rounded-md border dark:border-slate-600 p-4 md:bg-transparent md:border-0 md:p-0">
                    <p>Disfruto del <Highlight>diseño digital</Highlight> y de la <Highlight>programación</Highlight> en general.</p>
                    <p>He fusionado dichos gustos para especializarme en el desarollo <Highlight>Frontend.</Highlight></p>
