...
export function SlideMenu(props) {
    ...
    function setInnerHTML() {
        if (props.innerHTML) {
            return (
                <div className="mr-5" dangerouslySetInnerHTML={props.innerHTML}/>
            )
        }
    }
    ...
    return (
        <div 
            id={id}
            className={
                setBreakpoint() + "hidden w-full fixed top-0 z-20 bg-black/50" +
        ...
        >
            ...
            <div 
                className={
                    setHeight() + (props.className ? props.className + " " : "") +
    ...
    return (
        <div className="relative">
            <Button
                ...
                onClick={() => {toggleDotsMenu(id); toggleSlideMenu("slide-menu-nav", "hide")}} // Para abrir DotsMenu se cierra SlideMenu y viceversa
            >
                <Icon
