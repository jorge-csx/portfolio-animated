    ...
    const styles = [
      {
        name: "normal",
        style:
          "bg-gray-200/25 dark:bg-slate-700/25 border dark:border-slate-600 ",
      },
      {
        name: "blue",
        style:
          "bg-cyan-400 border border-cyan-500 dark:border-cyan-300 text-cyan-800 ",
      },
      {
        name: "red",
        style:
          "bg-red-400 border border-red-500 dark:border-red-300 text-red-800 ",
      },
      {
        name: "yellow",
        style:
          "bg-yellow-400 border border-yellow-500 dark:border-yellow-300 text-yellow-800 ",
      },
      {
        name: "green",
        style:
          "bg-emerald-400 border border-emerald-500 dark:border-emerald-300 text-emerald-800 ",
      },
    ];
...
export function FrameGroup(props) {
  return (
    <div className="flex flex-row gap-3 items-center w-[calc(50%_-_0.5rem)]">
      <Frame
        padding="p-2"
        className={props.frameClassName}
...
export function Collapse(props) {
  ...
  return (
    <div
      className={
        "mb-3 relative" + (props.className ? " " + props.className : "")
      }
    >
